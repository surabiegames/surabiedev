/**
 * Root layout aplikasi PETUGAS GANGGUAN "Tirtawening Gangguan". Memasang tema, area aman, status bar, dan
 ...
 * tidak ada tiket untuk dikerjakan — jadi gerbang mengarahkan ke layar masuk.
 *
