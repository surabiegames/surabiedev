// apps/web/scripts/reset-pencatat-password.ts — set ULANG password SEMUA akun
...
// kuat.
//
// WAJIB via `pnpm reset-pencatat-password` dari apps/web (tsx --conditions=react-server) — @workspace/auth/password mengimpor
// "server-only".
import "./env"
