...
import { GlassPanel, MasterPalette as P, StatusBadge, toneStatusPengaduan, useTheme } from '@/components';
  ...
  return (
    ...
    >
      ...
      {tiket == null ? (
        ...
        <GlassPanel>
          <Text style={{ color: colors.mutedForeground, fontSize: 12.5, lineHeight: 19 }}>
  ...
  return (
    <GlassPanel padding={14} onPress={onPress} style={styles.baris}>
      <View style={styles.barisAtas}>
        {tiket.lewatSla ? <TriangleAlert size={15} color={colors.destructive} /> : null}
...
const styles = StyleSheet.create({
  ...
  nomorTiket: { flex: 1, fontSize: 12.5, fontWeight: '700' },
  judulTiket: { fontSize: 13, fontWeight: '500', marginTop: 6 },
  rincian: { fontSize: 11.5, marginTop: 2 },
  barisBawah: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  sla: { fontSize: 11, fontWeight: '600' },
});
