...
/**
 * SATU SUDUT UNTUK SEMUA: 6 px (varian R2, keputusan 2026-07-27 — "rounded
 * small di semua konten dan halamannya").
 *
 * Sengaja tidak bertingkat. Skala radius bertingkat (16 kartu / 12 kontrol /
 * 8 elemen kecil) membuat kotak kecil seperti nomor urut terlihat lonjong
 * sementara kartu besar terlihat gembur — dan tidak ada yang bisa menyebut
 * aturannya. Satu nilai menghilangkan seluruh pertanyaan itu.
 *
 * `bundar` tetap terpisah karena ia bukan "sudut", melainkan bentuk:
 * lingkaran penuh untuk avatar, lencana, dan tombol mengambang.
 */
export const Radius = {
  kartu: 6,
  kontrol: 6,
  kecil: 6,
  dialog: 6,
  /** Lingkaran penuh: avatar, lencana, tombol mengambang. */
  bundar: 999,
} as const;
